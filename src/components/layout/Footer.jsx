      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 items-start">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-background/60 text-sm leading-relaxed">
              Professional industrial solutions — mobile maintenance service vans, illumination tower, and IoT-enabled smart monitoring.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                <Link key={link.path} to={link.path} onClick={scrollToTop} className="block text-sm text-background/60 hover:text-secondary transition-colors">
                  {link.label}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {products.map((product) => (
                <Link key={product.name} to="/products" onClick={scrollToTop} className="block text-sm text-background/60 hover:text-secondary transition-colors">
                  {product.name}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-background/60">393, Phase III, Udyog Vihar, Sector 19, Gurugram, Haryana 122016</p>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-background/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link to="/privacy-policy" onClick={scrollToTop} className="text-sm text-background/40 hover:text-secondary transition-colors">
              Privacy Policy
            </Link>
            <a
